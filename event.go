...
type Event struct {
	...
	PlayerJoinSuccess func(key interface{}, pMgr *pmgr.PMgr, alreadyExist bool, extend map[string]interface{}) bool
	PlayerJoinFail    func(key interface{}, kind EventPlayerJoinFailKind, extend map[string]interface{})
	PlayerExit        func(key interface{}, pMgr *pmgr.PMgr, extend map[string]interface{}) bool
